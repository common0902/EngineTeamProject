...
{
    public class MiddleBossAttackState : MiddleBossState
    {
        private MiddleBossAttack _bossAttack;
        public MiddleBossAttackState(MiddleBoss boss, string animName, MiddleBossStateMachine stateMachine) : base(boss, animName, stateMachine)
        {
